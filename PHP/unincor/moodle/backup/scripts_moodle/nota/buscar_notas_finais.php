...
$functionname = 'gradereport_overview_get_course_grades'; // função do webservice do moodle
...
//filtro de notas
$param['userid']= 37; //especifique do usuário.
//$param['courseid'] = 76; //id do curso
