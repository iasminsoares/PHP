<?php
//Esse script de conexão de inserir grupo no agrupamento com moodle via webservice
...
// echo 'Grupo inserido no agrupamento com sucesso!!';
...
$functionname = 'core_group_assign_grouping'; // função do webservice do moodle
...
$assignment->groupingid  = 2; //id do agrupamento
$assignment->groupid   = 4; //id do grupo
