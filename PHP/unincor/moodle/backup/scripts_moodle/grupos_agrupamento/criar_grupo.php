...
$group= new stdClass();
$group->courseid          = 84; //TODO - set the course id //DISCIPLINA REAL
$group->name              = 'Grupo B'; // NOME DA TURMA 
$group->description       = 'Test groupC description';
$group->idnumber          = 'testgroup-02';
